  ...
  return (
    <>
      ...
      <div
        ...
        className={
          sidebar
            ? "duration-300 ease-in tablet:hidden h-screen flex flex-col justify-start items-end fixed w-full z-50 top-0 right-0 py-6 px-6 transition-all dark:bg-black bg-white dark:text-white"
